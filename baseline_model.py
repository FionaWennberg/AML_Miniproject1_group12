...
def random_search_rf_baseline(X, y, groups, n_iters=20, random_state=42):
...
# Random baseline (20 iterations)
baseline = random_search_rf_baseline(X, y, groups, n_iters=20, random_state=42)
